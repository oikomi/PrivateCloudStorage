 ...
 */
public class MkdirDialog extends Dialog {
    ...
    public MkdirDialog(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        this.context = context;
    }

    public MkdirDialog(Context context, LeaveMyDialogListener listener) {
        super(context);
        // TODO Auto-generated constructor stub
        this.context = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i("MkdirDialog", "onCreate");
        // TODO Auto-generated method stub
        super.onCreate(savedInstanceState);
        this.setContentView(R.layout.activity_mkdir_dialog);
